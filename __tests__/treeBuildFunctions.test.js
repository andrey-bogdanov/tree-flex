...
import { bezier, stright, roundedAngles } from "../src/components/tree-component/pathShapes"
...
describe ("createPath, creates object with svg path and path id", () => {
  ...
  test ("path content, stright", () => {
    expect(createPath(nodeArray[1], nodeArray[2], stright)).toEqual(
      { 
